package de.scandio.confluence.plugins.abstractmailprocessor;
...
public abstract class AbstractMailProcessorJob extends AbstractJob {
     ...
     * news entry
     */
    protected String blogEntryContent;
     ...
     */
    protected List<InputStream> attachmentsInputStreams;
     ...
     */
    public AbstractMailProcessorJob() {
     ...
     */
    protected void sendErrorMessage(Message m, String error) throws Exception // FIXME this method should use the higher level email sending facilities in confluence instead of this low level approach
    {
    ...
    private void handlePart(Part part) throws MessagingException, IOException {
        ...
        else
        {
            ...
            try {
                ...
                attachments.add(a);
                attachmentsInputStreams.add(bais);
     ...
     */
    protected Space getSpaceFromAddress(Message message) throws Exception
    {
    ...
    abstract protected void process(Message m) throws MessagingException;

    protected String getEmailAddressFromMessage(Message m) throws MessagingException
    {
     ...
     *
     * @param spaceManager The SpaceManager of this Confluence instance
     */
